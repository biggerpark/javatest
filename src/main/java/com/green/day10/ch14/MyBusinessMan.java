...
class BusinessMan extends Man{ // 1) BusinessMan 클래스가 Man 클래스를 상속받을것이다(extends 사용)
    ...
    public BusinessMan(String name,String company, String position) { // 2)빨간줄이 뜨는 이유:
         ...
         */
        super(name);//부모 생성자 호출을 통해서 this.name=name; 과 동일한 효과를 가진다.
